...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v2.1.9
>
...
![status](https://img.shields.io/badge/version-v2.1.9-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🚀 **v2.1.9 自动更新版**：打包 Electron 并发布 GitHub Release 自动更新；继续收口俄罗斯方块大屏/隐藏奖励/通关过场、Codex CLI Agent 创作台和简约模式、Grok Agent 视频链路、FAL 超市新增模型与多主题可读性修复
