...
> AI 节点画布工作流工具 · Web + Electron 桌面端｜v1.8.1
>
...
![status](https://img.shields.io/badge/version-v1.8.1-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
- 🧭 **扩展 API 平台基础地基**（v1.8.1）：后端新增扩展平台配置注册表、脱敏保存和媒体解析地基，ModelScope、火山引擎、本地 ComfyUI、即梦 CLI 与 OpenAI 兼容平台仍作为高级可选入口推进；默认不改变贞贞工坊 / RunningHub / LLM 独立 Key 主流程
